...
activities = {
    ...
    "Track and Field": {
        "description": "Running, jumping, and throwing sports events",
...
def get_activities(response: Response):
    # Disable caching so the UI always gets fresh participant data.
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Remove all registrations for this email from the activity
